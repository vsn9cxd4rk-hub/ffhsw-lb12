...
"C:\Programme\MySQL\MySQL Server 5.5\bin\mysqld.exe" --install
net start mysql

REM Konfiguriere Datenbank
echo Configurating MySQL Server...
"C:\Programme\MySQL\MySQL Server 5.5\bin\mysqlinstanceconfig.exe" -i -q ServiceName=MySQL RootPassword=root_fms ServerType=SERVER DatabaseType=INNODB Port=3306 Charset=utf8
