...
public class VerdienstausfallbescheinigungPDFSchreiben {
   ...
   public void createPdf(String filename, String veranstaltung, int mID, String am, String bis, String vonUhr, String bisUhr) throws DocumentException, IOException, SQLException {
      ...
      try {
         Chunk e = new Chunk("VERDIENSTAUSFALLBESCHEINIGUNG   ", UEBERSCHRIFT);
         ...
         textblock.add(e);
         textblock.add(Chunk.NEWLINE);
         e = new Chunk("Bankverbindung:    ", NORMAL_BOLD);
         textblock.add(e);
         e = new Chunk("_______________________________________________________", NORMAL_FONT);
         textblock.add(e);
         textblock.add(Chunk.NEWLINE);
         textblock.add(Chunk.NEWLINE);
