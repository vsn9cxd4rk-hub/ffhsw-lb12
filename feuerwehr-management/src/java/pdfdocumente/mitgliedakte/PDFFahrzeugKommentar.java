...
public class PDFFahrzeugKommentar {
   ...
   public void createPdf(String filename, String fahrzeugname, String kommentar) throws DocumentException, IOException, SQLException {
      ...
      Chunk address = new Chunk("Fahrzeug: " + fahrzeugname, UEBERSCHRIFT);
      personal.add(Chunk.NEWLINE);
      personal.add(Chunk.NEWLINE);
      personal.add(address);
      personal.add(Chunk.NEWLINE);
      address = new Chunk("Folgender Kommentar wurde in die Fahrzeugakte eingetragen:", NORMAL_FONT);
      personal.add(Chunk.NEWLINE);
      personal.add(address);
      personal.add(Chunk.NEWLINE);
      personal.add(Chunk.NEWLINE);
      address = new Chunk(kommentar, NORMAL_FONT);
      personal.add(Chunk.NEWLINE);
      personal.add(address);
   ...
   public static void PDFdocumentErstellen(String dateiname, String fahrzeugName, String kommentar) throws DocumentException, IOException {
      PDFFahrzeugKommentar ps = new PDFFahrzeugKommentar();

      try {
         ps.createPdf(dateiname, fahrzeugName, kommentar);
         ps.printMeasures();
