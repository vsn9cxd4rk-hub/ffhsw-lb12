...
public class Fahrzeug {
   ...
   public String getHomepageBild() {
      return this.homepageBild;
   }

   public void setHomepageBild(String homepageBild) {
      this.homepageBild = homepageBild;
   }
