...
public class RegelnHubrettungsfahrzeuge extends FahrzeugEinteilungAO {

   private static final long serialVersionUID = 1L;


   public static void Hubrettungsfahrzeuge(int x, int fahrzeugID, String aktuelleFahrzeugName, HashMap listen) throws SQLException {
      logging.logInfo("Erzeuge Fahrzeugeinteilung nach Regel: RegelnHubrettungsfahrzeuge");
      ...
      sitzplatz[x][0] = new JComboBox((String[])listen.get("dlkGFListe"));
      sitzplatz[x][1] = new JComboBox((String[])listen.get("dlkFahrerListe"));
      ...
      logging.logInfo(aktuelleFahrzeugName + " Leiterführer");
      ...
      logging.logInfo(aktuelleFahrzeugName + " Leitermaschinist");
