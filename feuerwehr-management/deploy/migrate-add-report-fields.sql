-- =============================================================================
-- Migration: Einsatzbericht-, Kräftenachweis- und FENIX-Erweiterungen
-- Datenbank: FFWVSLB12
--
...
--   1. Einsatzbericht-Felder (operations)
--   2. Kräftenachweis-Tabelle (operation_personnel)
--   3. User-Member-Verknüpfung (users.memberId)
--   4. Lehrgangskategorien: Qualifikationszuordnung (course_categories.qualificationField)
--   5. AGT-Nachweistabelle (agt_records)
--   6. Einsatzstatistik-Felder (operationResult, wasActivelyInvolved)
--   7. Berechtigungs-Bits (br1-br3) statt starrer Gruppen-IDs
--
...
-- =============================================================================
-- 3. User-Member-Verknüpfung (Punkt 3: Personal & Benutzer verschaltet)
--    Ein User kann optional einem Mitglied zugeordnet werden (1:1).
-- =============================================================================
CALL _add_column_if_not_exists('users', 'memberId', 'INT NULL');

-- Unique Key (nur hinzufügen wenn nicht vorhanden)
...
-- =============================================================================
-- 4. Lehrgangskategorien: Qualifikationszuordnung (Punkt 4)
--    Wenn ein Lehrgang dieser Kategorie abgeschlossen wird, wird die hier
--    hinterlegte Qualifikation automatisch beim Mitglied gesetzt.
--    Gültige Werte: qualAGT, qualTruppmann, qualTruppfuehrer, qualGruppenfuehrer,
--    qualZugfuehrer, qualMachinist, qualRadioOperator, qualFirstAid,
--    qualRettSan, qualFwSan, qualVerbandfuehrer, qualLicenseB, qualLicenseC, qualTH1
-- =============================================================================
CALL _add_column_if_not_exists('course_categories', 'qualificationField', 'VARCHAR(50) NULL');

-- Vorbelegte Zuordnungen für Standard-Kategorien (nur wenn Feld leer ist)
...
-- =============================================================================
-- 5. AGT-Nachweistabelle (Punkt 5: AGT-Tauglichkeit)
--    Laufende Dokumentation von G26-Untersuchungen, Belastungsübungen,
--    Einsatzübungen und AGT-Einsätzen pro Mitglied.
-- =============================================================================
...
--    operationResult: Einsatzresultat (Brand Real, THL Fehl, etc.)
--    wasActivelyInvolved: War der LB aktiv tätig?
-- =============================================================================
...
--    br1 = Fahrzeuge, br2 = Einsätze/Statistik/Personalliste, br3 = Gerätewart-
--    Bereich (Bestandsliste/Prüfbuch/Mängel). Bestehende Gruppen bekommen genau
--    die Bits, die ihrem bisherigen Verhalten entsprechen (keine Verhaltens-
--    änderung). Zusätzlich wird eine Beispiel-Kombigruppe angelegt, die zeigt,
--    wie sich Fähigkeiten frei kombinieren lassen (z.B. Gerätewart, der
--    zugleich Gruppenführer ist).
-- =============================================================================
...
-- =============================================================================
-- Aufräumen: Hilfsprozedur entfernen
-- =============================================================================
DROP PROCEDURE IF EXISTS `_add_column_if_not_exists`;
