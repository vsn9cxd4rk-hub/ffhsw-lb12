...
public class EinsatzProStundeAO
extends JFrame {
    ...
    public static void start(final int jahr) {
        ...
        Thread threadStatistik = new Thread(){
            ...
            @Override
            public void run() {
                EinsatzProStundeAO einsatzProStunde = new EinsatzProStundeAO(jahr);
    ...
    public EinsatzProStundeAO(int jahr) {
        super("FeuerwehrManagementSystem - Eins\u00e4tze pro Stunde");
        this.myButtons(jahr);
        JPanel jpanel = EinsatzProStundeAO.createPanel(jahr);
    ...
    public static CategoryDataset createDataset(int jahr) {
        ...
        String s = "Eins\u00e4tze pro Stunde";
        TabelleEinsatz einsatz = new TabelleEinsatz();
        try {
            int i = 0;
            while (i < 24) {
                defaultcategorydataset.addValue((double)einsatz.getEinsatzProStunde(jahr, i), (Comparable)((Object)s), (Comparable)((Object)(i + "h")));
                ++i;
            }
        }
    ...
    public static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createBarChart((String)" ", (String)"Stunde", (String)"Anzahl Eins\u00e4tze", (CategoryDataset)categorydataset, (PlotOrientation)PlotOrientation.VERTICAL, (boolean)true, (boolean)true, (boolean)false);
    ...
    public static JPanel createPanel(int jahr) {
        JFreeChart jfreechart = EinsatzProStundeAO.createChart(EinsatzProStundeAO.createDataset(jahr));
    ...
    private void myButtons(final int jahr) {
        ...
        buttonNeuLaden.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (jahresAuswahl.getSelectedItem().toString().equals("<bitte w\u00e4hlen>")) {
                    ...
                    EinsatzProStundeAO.this.dispose();
                    ...
                    EinsatzProStundeAO.start(Integer.parseInt(jahresAuswahl.getSelectedItem().toString()));
                }
            }
        });
        ...
        buttonPdfExport.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                EinsatzProStundeAO.this.chooser.setFileSelectionMode(1);
                EinsatzProStundeAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte PDF Export in: " + EinsatzProStundeAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzProStundeAO.this.chooser.getSelectedFile().getPath()) + "/EinsatzProStunde_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".pdf";
                MyChartUtils.writeChartToPDF(EinsatzProStundeAO.createChart(EinsatzProStundeAO.createDataset(jahr)), 550, 800, outputFile);
        ...
        buttonJpgExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                EinsatzProStundeAO.this.chooser.setFileSelectionMode(1);
                EinsatzProStundeAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte JPG Export in: " + EinsatzProStundeAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzProStundeAO.this.chooser.getSelectedFile().getPath()) + "/EinsatzProStunde_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".jpg";
                MyChartUtils.writeChartToJPEG(EinsatzProStundeAO.createChart(EinsatzProStundeAO.createDataset(jahr)), 1000, 800, outputFile);
