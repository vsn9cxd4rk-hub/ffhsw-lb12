...
public class EinsatzMannstundenAO
extends JFrame {
    ...
    public static void start() {
        EinsatzMannstundenAO mannstunden = new EinsatzMannstundenAO();
    ...
    public EinsatzMannstundenAO() {
        super("FeuerwehrManagementSystem - Mannstunden Einsatz");
        this.myButtons();
        JPanel jpanel = EinsatzMannstundenAO.createPanel();
    ...
    public static CategoryDataset createDataset() {
        ...
        try {
            ...
            while (i < jahre.length) {
                defaultcategorydataset.addValue((double)statistik.getZusammengerechneteMannstunden(jahre[i]), (Comparable)((Object)s), (Comparable)((Object)Integer.toString(jahre[i])));
                ++i;
            }
        }
    ...
    public static JPanel createPanel() {
        JFreeChart jfreechart = EinsatzMannstundenAO.createChart(EinsatzMannstundenAO.createDataset());
    ...
    private void myButtons() {
        ...
        buttonPdfExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                EinsatzMannstundenAO.this.chooser.setFileSelectionMode(1);
                EinsatzMannstundenAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte PDF Export in: " + EinsatzMannstundenAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzMannstundenAO.this.chooser.getSelectedFile().getPath()) + "/Ausr\u00fcckezeit_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".pdf";
                MyChartUtils.writeChartToPDF(EinsatzMannstundenAO.createChart(EinsatzMannstundenAO.createDataset()), 550, 800, outputFile);
        ...
        buttonJpgExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                EinsatzMannstundenAO.this.chooser.setFileSelectionMode(1);
                EinsatzMannstundenAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte JPG Export in: " + EinsatzMannstundenAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzMannstundenAO.this.chooser.getSelectedFile().getPath()) + "/Ausr\u00fcckezeit_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".jpg";
                MyChartUtils.writeChartToJPEG(EinsatzMannstundenAO.createChart(EinsatzMannstundenAO.createDataset()), 1000, 800, outputFile);
