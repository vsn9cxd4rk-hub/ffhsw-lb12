...
public class AnwesenheitDienstabendAO
extends JFrame {
    ...
    public static void start(final int jahr) {
        ...
        Thread threadStatistik = new Thread(){
            ...
            @Override
            public void run() {
                AnwesenheitDienstabendAO anweseneheitStatistik = new AnwesenheitDienstabendAO(jahr);
    ...
    public AnwesenheitDienstabendAO(int jahr) {
        super("FeuerwehrManagementSystem - Anwesenheitstatistik Dienstabend");
        this.myButtons(jahr);
        JPanel jpanel = AnwesenheitDienstabendAO.createPanel(jahr);
    ...
    public static CategoryDataset createDataset(int jahr) {
        ...
        try {
            ...
            while (i < mitgliederListe.length) {
                int wert = tabAnwesend.getBeteiligungByKategorie(tabMitglieder.getIdByGuiString(mitgliederListe[i]), 2, jahr);
    ...
    public static JPanel createPanel(int jahr) {
        JFreeChart jfreechart = AnwesenheitDienstabendAO.createChart(AnwesenheitDienstabendAO.createDataset(jahr));
    ...
    private void myButtons(final int jahr) {
        ...
        buttonNeuLaden.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (jahresAuswahl.getSelectedItem().toString().equals("<bitte w\u00e4hlen>")) {
                    ...
                    AnwesenheitDienstabendAO.this.dispose();
                    ...
                    AnwesenheitDienstabendAO.start(Integer.parseInt(jahresAuswahl.getSelectedItem().toString()));
                }
            }
        });
        ...
        buttonPdfExport.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                AnwesenheitDienstabendAO.this.chooser.setFileSelectionMode(1);
                AnwesenheitDienstabendAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte PDF Export in: " + AnwesenheitDienstabendAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(AnwesenheitDienstabendAO.this.chooser.getSelectedFile().getPath()) + "/AnwesenheitDienstabendListPDF_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".pdf";
                MyChartUtils.writeChartToPDF(AnwesenheitDienstabendAO.createChart(AnwesenheitDienstabendAO.createDataset(jahr)), 550, 800, outputFile);
        ...
        buttonJpgExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                AnwesenheitDienstabendAO.this.chooser.setFileSelectionMode(1);
                AnwesenheitDienstabendAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte JPG Export in: " + AnwesenheitDienstabendAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(AnwesenheitDienstabendAO.this.chooser.getSelectedFile().getPath()) + "/AnwesenheitDienstabendListJPG_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".jpg";
                MyChartUtils.writeChartToJPEG(AnwesenheitDienstabendAO.createChart(AnwesenheitDienstabendAO.createDataset(jahr)), 1000, 800, outputFile);
