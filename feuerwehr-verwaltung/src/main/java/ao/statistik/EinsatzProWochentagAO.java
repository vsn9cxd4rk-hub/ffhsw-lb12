...
public class EinsatzProWochentagAO
extends JFrame {
    ...
    public static void start(final int jahr) {
        ...
        Thread threadStatistik = new Thread(){
            ...
            @Override
            public void run() {
                EinsatzProWochentagAO einsatzProWochentag = new EinsatzProWochentagAO(jahr);
                einsatzProWochentag.setSize(runApplication.widthStatistikGUI, runApplication.higthStatistikGUI);
                einsatzProWochentag.setDefaultCloseOperation(2);
                einsatzProWochentag.add(buttonZurueck);
                einsatzProWochentag.add(buttonPdfExport);
                einsatzProWochentag.add(buttonJpgExport);
                einsatzProWochentag.add(jahresAuswahl);
                einsatzProWochentag.add(buttonNeuLaden);
                RefineryUtilities.centerFrameOnScreen((Window)einsatzProWochentag);
                Image icon = new ImageIcon("images/icon.jpg").getImage();
                einsatzProWochentag.setIconImage(icon);
                if (runApplication.EINSTELLUNGEN.get("AlwaysOnTop").equals("1")) {
                    einsatzProWochentag.setAlwaysOnTop(true);
                }
    ...
    public EinsatzProWochentagAO(int jahr) {
        super("FeuerwehrManagementSystem - Eins\u00e4tze pro Wochentag");
        this.myButtons(jahr);
        JPanel jpanel = EinsatzProWochentagAO.createPanel(jahr);
    ...
    public static CategoryDataset createDataset(int jahr) {
        ...
        String s = "Eins\u00e4tze pro Wochentag";
        TabelleStatistikEinsatz einsatz = new TabelleStatistikEinsatz();
        try {
            int i = 0;
            while (i < 7) {
                ...
                defaultcategorydataset.addValue((double)einsatz.getEinsatzProWochentag(jahr, i), (Comparable)((Object)s), (Comparable)((Object)wochentagName));
                ++i;
            }
        }
    ...
    public static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createBarChart((String)" ", (String)"Wochentag", (String)"Anzahl Eins\u00e4tze", (CategoryDataset)categorydataset, (PlotOrientation)PlotOrientation.VERTICAL, (boolean)true, (boolean)true, (boolean)false);
    ...
    public static JPanel createPanel(int jahr) {
        JFreeChart jfreechart = EinsatzProWochentagAO.createChart(EinsatzProWochentagAO.createDataset(jahr));
    ...
    private void myButtons(final int jahr) {
        ...
        buttonNeuLaden.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (jahresAuswahl.getSelectedItem().toString().equals("<bitte w\u00e4hlen>")) {
                    ...
                    EinsatzProWochentagAO.this.dispose();
                    ...
                    EinsatzProWochentagAO.start(Integer.parseInt(jahresAuswahl.getSelectedItem().toString()));
                }
            }
        });
        ...
        buttonPdfExport.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                EinsatzProWochentagAO.this.chooser.setFileSelectionMode(1);
                EinsatzProWochentagAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte PDF Export in: " + EinsatzProWochentagAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzProWochentagAO.this.chooser.getSelectedFile().getPath()) + "/EinsatzProWochentag_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".pdf";
                MyChartUtils.writeChartToPDF(EinsatzProWochentagAO.createChart(EinsatzProWochentagAO.createDataset(jahr)), 550, 800, outputFile);
        ...
        buttonJpgExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                EinsatzProWochentagAO.this.chooser.setFileSelectionMode(1);
                EinsatzProWochentagAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte JPG Export in: " + EinsatzProWochentagAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzProWochentagAO.this.chooser.getSelectedFile().getPath()) + "/EinsatzProWochentag_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".jpg";
                MyChartUtils.writeChartToJPEG(EinsatzProWochentagAO.createChart(EinsatzProWochentagAO.createDataset(jahr)), 1000, 800, outputFile);
