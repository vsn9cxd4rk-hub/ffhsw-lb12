...
public class EinsatzProMonatAO
extends JFrame {
    ...
    public static void start(final int jahr) {
        ...
        Thread threadStatistik = new Thread(){
            ...
            @Override
            public void run() {
                EinsatzProMonatAO einsatzProMonat = new EinsatzProMonatAO(jahr);
                einsatzProMonat.setSize(runApplication.widthStatistikGUI, runApplication.higthStatistikGUI);
                einsatzProMonat.setDefaultCloseOperation(2);
                einsatzProMonat.add(buttonZurueck);
                einsatzProMonat.add(buttonPdfExport);
                einsatzProMonat.add(buttonJpgExport);
                einsatzProMonat.add(jahresAuswahl);
                einsatzProMonat.add(buttonNeuLaden);
                RefineryUtilities.centerFrameOnScreen((Window)einsatzProMonat);
                Image icon = new ImageIcon("images/icon.jpg").getImage();
                einsatzProMonat.setIconImage(icon);
                if (runApplication.EINSTELLUNGEN.get("AlwaysOnTop").equals("1")) {
                    einsatzProMonat.setAlwaysOnTop(true);
                }
    ...
    public EinsatzProMonatAO(int jahr) {
        super("FeuerwehrManagementSystem - Eins\u00e4tze pro Monat");
        this.myButtons(jahr);
        JPanel jpanel = EinsatzProMonatAO.createPanel(jahr);
    ...
    public static CategoryDataset createDataset(int jahr) {
        ...
        try {
            ...
            while (i < 12) {
                ...
                defaultcategorydataset.addValue((double)einsatz.getEinsatzProMonat(jahr, i + 1), (Comparable)((Object)s), (Comparable)((Object)monatName));
                ++i;
            }
        }
    ...
    public static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createBarChart((String)" ", (String)"Monat", (String)"Anzahl Eins\u00e4tze", (CategoryDataset)categorydataset, (PlotOrientation)PlotOrientation.VERTICAL, (boolean)true, (boolean)true, (boolean)false);
    ...
    public static JPanel createPanel(int jahr) {
        JFreeChart jfreechart = EinsatzProMonatAO.createChart(EinsatzProMonatAO.createDataset(jahr));
    ...
    private void myButtons(final int jahr) {
        ...
        buttonNeuLaden.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                if (jahresAuswahl.getSelectedItem().toString().equals("<bitte w\u00e4hlen>")) {
                    ...
                    EinsatzProMonatAO.this.dispose();
                    ...
                    EinsatzProMonatAO.start(Integer.parseInt(jahresAuswahl.getSelectedItem().toString()));
                }
            }
        });
        ...
        buttonPdfExport.addActionListener(new ActionListener(){
            ...
            @Override
            public void actionPerformed(ActionEvent arg0) {
                EinsatzProMonatAO.this.chooser.setFileSelectionMode(1);
                EinsatzProMonatAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte PDF Export in: " + EinsatzProMonatAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzProMonatAO.this.chooser.getSelectedFile().getPath()) + "/EinsatzProMonat_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".pdf";
                MyChartUtils.writeChartToPDF(EinsatzProMonatAO.createChart(EinsatzProMonatAO.createDataset(jahr)), 550, 800, outputFile);
        ...
        buttonJpgExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                EinsatzProMonatAO.this.chooser.setFileSelectionMode(1);
                EinsatzProMonatAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte JPG Export in: " + EinsatzProMonatAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(EinsatzProMonatAO.this.chooser.getSelectedFile().getPath()) + "/EinsatzProMonat_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".jpg";
                MyChartUtils.writeChartToJPEG(EinsatzProMonatAO.createChart(EinsatzProMonatAO.createDataset(jahr)), 1000, 800, outputFile);
