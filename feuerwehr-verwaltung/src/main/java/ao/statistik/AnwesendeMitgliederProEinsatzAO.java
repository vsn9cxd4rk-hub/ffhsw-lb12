...
public class AnwesendeMitgliederProEinsatzAO
extends JFrame {
    ...
    public static void start() {
        AnwesendeMitgliederProEinsatzAO anwesendeMitglieder = new AnwesendeMitgliederProEinsatzAO();
    ...
    public AnwesendeMitgliederProEinsatzAO() {
        super("FeuerwehrManagementSystem - Anwesende Mitglieder");
        this.myButtons();
        JPanel jpanel = AnwesendeMitgliederProEinsatzAO.createPanel();
    ...
    public static CategoryDataset createDataset() {
        ...
        String s = "Durchschnittlich Anwesende Mitglieder (Einsatz)";
        ...
        try {
            ...
            while (i < jahre.length) {
                double mengeDerMitglieder = tabAnwesenheit.getGesamtVeranstaltungByKategorie(1, jahre[i]);
                double anzahlDerEin\u00e4tze = tabVeranstaltung.getCountAllVeranstaltungEinesJahresByKategorie(Integer.toString(jahre[i]), 1);
                double ergebnis = mengeDerMitglieder / anzahlDerEin\u00e4tze;
    ...
    public static JFreeChart createChart(CategoryDataset categorydataset) {
        JFreeChart jfreechart = ChartFactory.createBarChart((String)" ", (String)"Jahr", (String)"Durchschnittlich Anwesende Mitglieder (Einsatz)", (CategoryDataset)categorydataset, (PlotOrientation)PlotOrientation.VERTICAL, (boolean)true, (boolean)true, (boolean)false);
    ...
    public static JPanel createPanel() {
        JFreeChart jfreechart = AnwesendeMitgliederProEinsatzAO.createChart(AnwesendeMitgliederProEinsatzAO.createDataset());
    ...
    private void myButtons() {
        ...
        buttonPdfExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                AnwesendeMitgliederProEinsatzAO.this.chooser.setFileSelectionMode(1);
                AnwesendeMitgliederProEinsatzAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte PDF Export in: " + AnwesendeMitgliederProEinsatzAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(AnwesendeMitgliederProEinsatzAO.this.chooser.getSelectedFile().getPath()) + "/Ausr\u00fcckezeit_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".pdf";
                MyChartUtils.writeChartToPDF(AnwesendeMitgliederProEinsatzAO.createChart(AnwesendeMitgliederProEinsatzAO.createDataset()), 550, 800, outputFile);
        ...
        buttonJpgExport.addActionListener(new ActionListener(){
            ...
            public void actionPerformed(ActionEvent arg0) {
                AnwesendeMitgliederProEinsatzAO.this.chooser.setFileSelectionMode(1);
                AnwesendeMitgliederProEinsatzAO.this.chooser.showSaveDialog(null);
                logging.logInfo((Object)("Starte JPG Export in: " + AnwesendeMitgliederProEinsatzAO.this.chooser.getSelectedFile().getPath()));
                String outputFile = String.valueOf(AnwesendeMitgliederProEinsatzAO.this.chooser.getSelectedFile().getPath()) + "/Ausr\u00fcckezeit_Stand_" + SbcUtils.timeStamp((String)"dd.MM.yyyy") + ".jpg";
                MyChartUtils.writeChartToJPEG(AnwesendeMitgliederProEinsatzAO.createChart(AnwesendeMitgliederProEinsatzAO.createDataset()), 1000, 800, outputFile);
