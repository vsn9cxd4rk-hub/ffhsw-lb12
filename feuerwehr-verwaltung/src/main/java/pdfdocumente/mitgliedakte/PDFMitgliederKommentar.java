...
public class PDFMitgliederKommentar {
    ...
    public void createPdf(String filename, String mitglied, String kommentar) throws DocumentException, IOException, SQLException {
        ...
        personal.add((Element)Chunk.NEWLINE);
        address = new Chunk("Folgender Kommentar wurde in die Mitgliederakte eingetragen:", NORMAL_FONT);
        personal.add((Element)Chunk.NEWLINE);
        personal.add((Element)address);
        personal.add((Element)Chunk.NEWLINE);
        personal.add((Element)Chunk.NEWLINE);
    ...
    public static void PDFdocumentErstellen(String dateiname, String mitglied, String kommentar) throws DocumentException, IOException {
        PDFMitgliederKommentar ps = new PDFMitgliederKommentar();
        try {
            ps.createPdf(dateiname, mitglied, kommentar);
            ps.printMeasures();
