...
public class PDFFahrzeugInDienst {
    ...
    public void createPdf(String filename, String fahrzeug) throws DocumentException, IOException, SQLException {
        ...
        personal.add((Element)Chunk.NEWLINE);
        address = new Chunk("Das Fahrzeug " + fahrzeug + " wurde mit dem heutigen Tage wieder in Dienst gestellt.", NORMAL_FONT);
        personal.add((Element)Chunk.NEWLINE);
        personal.add((Element)address);
    ...
    public static void PDFdocumentErstellen(String dateiname, String fahrzeug) throws DocumentException, IOException {
        PDFFahrzeugInDienst ps = new PDFFahrzeugInDienst();
        try {
