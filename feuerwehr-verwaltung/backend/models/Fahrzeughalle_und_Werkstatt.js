...
const Fahrzeughalle_und_Werkstatt = sequelize.define('Fahrzeughalle_und_Werkstatt', {
  ...
  timestamps: false,
  tableName: 'Fahrzeughalle_und_Werkstatt'
});

module.exports = Fahrzeughalle_und_Werkstatt;
